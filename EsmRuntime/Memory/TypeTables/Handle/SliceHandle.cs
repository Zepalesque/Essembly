...
public readonly unsafe ref partial struct TypeHandle {
    public readonly ref struct SliceImpl : ITypeHandle<SliceImpl> {
        readonly Signature _sig;
        readonly u128 _sigHash;
        
        public SliceImpl(TypeHandle inner) {
    ...
    public static NatBox<TypeHandle> Slice(TypeHandle inner) {
        var impl = new SliceImpl(inner);
        var ptr = (SliceImpl*)NativeMemory.AlignedAlloc((nuint)sizeof(SliceImpl), 16);
        *ptr = impl;
